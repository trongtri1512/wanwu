...
const docTemplate = `{
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/mp_common.SyncAsrReq"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/mp_common.SyncAsrResp"
                        }
                    }
                }
            }
    ...
    "definitions": {
        ...
        "mp_common.SyncAsrReq": {
            ...
            "properties": {
                ...
                "messages": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/mp_common.SyncAsrReqMsg"
                    }
                },
                "model": {
                    "type": "string"
        ...
        "mp_common.SyncAsrReqC": {
            ...
            "properties": {
                "audio": {
                    "$ref": "#/definitions/mp_common.SyncAsrAudio"
                },
                "text": {
                    "type": "string"
                },
        ...
        "mp_common.SyncAsrReqMsg": {
            ...
            "properties": {
                "content": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/mp_common.SyncAsrReqC"
                    }
                },
                "role": {
                    "type": "string"
        ...
        "mp_common.SyncAsrReqMsgRespChoice": {
            "type": "object",
            "properties": {
                "finish_reason": {
                    "type": "string"
                ...
                "message": {
                    "$ref": "#/definitions/mp_common.SyncAsrRespMsg"
                }
            }
        },
        "mp_common.SyncAsrResp": {
            "type": "object",
            "properties": {
                "choices": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/mp_common.SyncAsrReqMsgRespChoice"
                    }
                },
                "code": {
                    "type": "integer"
        ...
        "mp_common.SyncAsrRespMsg": {
            "type": "object",
            "properties": {
                "content": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/mp_common.SyncAsrRespMsgC"
                    }
                },
                "extra": {
                    "type": "object",
        ...
        "mp_common.SyncAsrRespMsgC": {
            "type": "object",
            "properties": {
                "segmented_content": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/mp_common.SegmentedContent"
                    }
                },
                "text": {
                    "type": "string"
        ...
        "request.RagSearchKnowledgeBaseReq": {
            ...
            "properties": {
                ...
                "enable_vision": {
                    "description": "召回结果是否包含多模态文件(只在callback层做最后的赋值)",
                    "type": "boolean"
                },
                "knowledgeIdList": {
                    "type": "array",
        ...
        "request.WgaSandboxRunReq": {
            ...
            "properties": {
                ...
                "messages": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/request.WgaSandboxMessage"
                    }
                },
                "model": {
                ...
                "skills": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/request.WgaSandboxSkill"
                    }
                },
                "skipCleanup": {
                    "type": "boolean"
                ...
                "tools": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/request.WgaSandboxTool"
                    }
                }
            }
        },
        "request.WgaSandboxSkill": {
            "type": "object",
            "required": [
                "dir"
            ],
